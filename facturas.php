          ...
          <div class="col-12">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="" class="col-12 col-md-4" >
                              <input placeholder="Buscar factura" onkeyup="listarFacturas(this.value)" class="form-control" type="text" name="txt_buscar_facturas" id="txt_buscar_facturas" value="">
                        </div>
                ...
                <div id='contenedor_listado_facturas' class="table-responsive"></div>

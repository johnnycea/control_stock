...
<div class="row">
  ...
  <div class="container contenedor-principal" >
       ...
       <div class="col-12">
          ...
          <div><hr></div>
          <div>
            <button class="btn btn-success"  onclick="limpiarModalProductosElaborados();" data-toggle="modal" data-target="#modal_nuevo_producto_elaborado" >Agregar producto</button>
          </div>
          <div><hr></div>
